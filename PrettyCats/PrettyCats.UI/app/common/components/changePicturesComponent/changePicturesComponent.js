...
], function changePicturesComponentModule() {
	'use strict';

	angular.module("common.module")
		.component("changePicturesComponent", {
			bindings: {
				pictures: "=",
				returnBackUrl: "<"
			},
			templateUrl: "app/common/components/changePicturesComponent/changePicturesComponent.html",
