...
], function kittensImageWorkerModule(angular) {
	'use strict';

	kittensImageWorkerService.$inject = ['$http', 'configurationService'];

	angular.module('common.module').factory("kittensImageWorker", kittensImageWorkerService);

	function kittensImageWorkerService($http, configurationService) {
