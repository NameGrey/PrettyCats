...
], function kittenBackendCommunicatorModule(angular) {
	'use strict';

	kittenBackendCommunicator.$inject = ['$http', '$q', 'kittensImageWorker', 'configurationService'];

	angular.module('common.module').service("kittenBackendCommunicator", kittenBackendCommunicator);

	function kittenBackendCommunicator($http, $q, kittensImageWorker, configurationService) {
		var baseServerApiUrl = configurationService.ServerApi;
